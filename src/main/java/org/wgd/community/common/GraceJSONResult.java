package org.wgd.community.common;
...
public class GraceJSONResult {
    ...
    public static String okJson(Object data) {
        return JacksonUtil.getBeanToJson(new GraceJSONResult(data));
    }
    ...
    public static String okJson() {
        return JacksonUtil.getBeanToJson(new GraceJSONResult(ResponseStatusEnum.SUCCESS));
    }
    ...
    public static String errorMapJson(Map map) {
        return JacksonUtil.getBeanToJson(new GraceJSONResult(ResponseStatusEnum.FAILED, map));
    }
    ...
    public static String errorCustomJson(ResponseStatusEnum responseStatus) {
        return JacksonUtil.getBeanToJson(new GraceJSONResult(responseStatus));
    }
